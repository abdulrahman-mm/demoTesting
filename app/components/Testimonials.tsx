...
import { Star, Quote, Award, TrendingUp, Zap, Brain, ChevronLeft, ChevronRight, PlayCircle, ExternalLink, Calendar, Briefcase } from 'lucide-react';
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      company: 'Google',
      image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Priya&backgroundType=gradientLinear&backgroundColor=b6e3f4,c0aede,d1d4f9',
      content: 'Vira Academy transformed my career completely. The Python course was incredibly comprehensive - from Django to FastAPI to real ML projects. Within 3 months of completing the course, I received offers from 5 companies including Google.',
      rating: 5,
      salaryIncrease: '180%',
    ...
    },
    {
      ...
      image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Rahul&backgroundType=gradientLinear&backgroundColor=b6e3f4,c0aede,d1d4f9',
      content: 'The DevOps program at Vira Academy is top-notch. The hands-on labs with Kubernetes, AWS, and CI/CD pipelines prepared me perfectly for real-world scenarios. My mentor helped me land my dream job at AWS with a massive salary hike.',
      rating: 5,
      salaryIncrease: '220%',
    ...
    },
    {
      ...
      role: 'Frontend Lead',
      company: 'Microsoft',
      image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Anjali&backgroundType=gradientLinear&backgroundColor=b6e3f4,c0aede,d1d4f9',
      content: 'I came from a non-tech background, but Vira Academy made the transition smooth. The React course covered everything from basics to advanced concepts. Today, I lead a team at Microsoft building cutting-edge React applications.',
      rating: 5,
      salaryIncrease: '250%',
    ...
    },
    {
      ...
      company: 'TCS Digital',
      image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Vikram&backgroundType=gradientLinear&backgroundColor=b6e3f4,c0aede,d1d4f9',
      content: 'The 1:1 mentorship at Vira Academy was game-changing. My mentor helped me build a portfolio that stood out. I went from ₹6 LPA to ₹18 LPA in just 6 months. The placement team was incredibly supportive throughout.',
      rating: 5,
      salaryIncrease: '200%',
    ...
    },
    {
      ...
      role: 'Cloud Engineer',
      company: 'Infosys',
      image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Neha&backgroundType=gradientLinear&backgroundColor=b6e3f4,c0aede,d1d4f9',
      content: 'As a working professional, the flexible schedule was crucial. The weekend batches and recorded sessions helped me upskill without leaving my job. The certification opened doors to better opportunities.',
      rating: 5,
      salaryIncrease: '150%',
    ...
    },
    {
      ...
      company: 'Wipro',
      image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Arun&backgroundType=gradientLinear&backgroundColor=b6e3f4,c0aede,d1d4f9',
      content: 'The React program helped me transition from a designer to a developer. The project-based learning approach gave me confidence to build real applications. Vira Academy truly cares about student success.',
      rating: 5,
      salaryIncrease: '170%',
      placementTime: '3 months',
      course: 'React Development',
      ...
      <div className="section-padding relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-orange-50 to-orange-100 backdrop-blur-sm px-6 py-3 rounded-2xl border border-orange-200/50 mb-6">
            ...
            <span className="text-sm font-semibold text-gray-900">Career Transformations</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Hear from our alumni who transformed their careers and achieved their dream jobs 
            through Vira Academy's industry-focused training programs.
          </p>
        </div>
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="p-8 md:p-12">
                  <div className="mb-8">
                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-50 to-orange-100 px-4 py-2 rounded-full mb-6">
                      ...
                      <span className="text-sm font-semibold text-gray-900">Vira Academy Alumni</span>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-[#FF7A1E] font-semibold">{activeTestimonial.role}</p>
                        <p className="text-gray-600">{activeTestimonial.company}</p>
                      </div>
                    </div>

                    <div className="flex items-center gap-2 mb-6">
                      {[...Array(activeTestimonial.rating)].map((_, i) => (
                        <Star key={i} className="w-5 h-5 fill-[#FF9A3E] text-[#FF9A3E]" />
                      ))}
                      <span className="text-sm text-gray-600 ml-2">{activeTestimonial.rating}/5 Rating</span>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-8">
                      <div className="text-center p-4 bg-orange-50 rounded-xl">
                        <div className="text-sm text-gray-600 mb-1">Course Taken</div>
                        <div className="font-bold text-gray-900">{activeTestimonial.course}</div>
                      </div>
                      <div className="text-center p-4 bg-green-50 rounded-xl">
                        <div className="text-sm text-gray-600 mb-1">Salary Increase</div>
                        <div className="font-bold text-green-600">{activeTestimonial.salaryIncrease}</div>
                      </div>
                      <div className="text-center p-4 bg-blue-50 rounded-xl">
                        <div className="text-sm text-gray-600 mb-1">Time to Placement</div>
                        <div className="font-bold text-blue-600">{activeTestimonial.placementTime}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-8 md:p-12 border-l border-gray-200">
                  <div className="h-full flex flex-col">
                    <div className="mb-8">
                      <h4 className="text-xl font-bold text-gray-900 mb-6">Success Journey</h4>
                      <div className="space-y-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">Joined Vira Academy</div>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">Mastered industry skills</div>
                          </div>
                        </div>
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">Landed dream role</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-auto">
                      <div className="mb-6">
                        <h5 className="font-semibold text-gray-900 mb-3">Start Your Success Story</h5>
                        <p className="text-sm text-gray-600 mb-4">
                          Join thousands of successful graduates who transformed their careers with Vira Academy.
                        </p>
                      </div>
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[#FF7A1E] font-medium">{testimonial.role}</p>
                  <p className="text-xs text-gray-600">{testimonial.company}</p>
                </div>
                <div className="flex items-center gap-1">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-3 h-3 fill-[#FF9A3E] text-[#FF9A3E]" />
                  ))}
                </div>
              </div>
              ...
              <div className="flex items-center justify-between text-xs text-gray-500">
                ...
                <span className="font-bold text-green-600">{testimonial.salaryIncrease} Hike</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 pt-12 border-t border-gray-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="text-center p-6 bg-white rounded-2xl border border-gray-200">
              <Zap className="w-12 h-12 text-[#FF7A1E] mx-auto mb-4" />
